...
public partial class Plugin
{
    ...
    private void InitializeHVT()
    {
        ...
        HVTEnabled = ModeConfigMigration.BindModeEnabled(Config, section, "HVT",
            "The first legitimate killer becomes the High-Value Target and earns 3 points each second while alive. "
            + "Other players hunt the HVT, and killing them transfers the role; the first player to reach the configured "
            + "point limit wins.");
