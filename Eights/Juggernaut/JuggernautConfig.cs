...
public partial class Plugin
{
    ...
    private void InitializeJuggernaut()
    {
        ...
        JuggernautEnabled = ModeConfigMigration.BindModeEnabled(Config, section,
            "Juggernaut",
            "The first killer becomes the powerful Juggernaut, while everyone else hunts them for the crown. "
            + "Normal kills award 10 points, killing the Juggernaut awards 20 points to the new holder, and the first player to "
