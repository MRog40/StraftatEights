...
internal static class TdmtatState
{
    ...
    {
        if (GameModeManager.ShouldDeferModeDisable(GameMode.Tdmtat, enabled))
        {
            return;
        }
    ...
    {
        ApplySettings(Plugin.TdmtatEnabled.Value);
    }
    ...
    internal static void PushSettingsIfHost()
    {
        ...
        ModeLobbyDataSync.Publish(SettingsLobbyDataKey, MyceliumNetwork.LobbyHost,
            GameModeManager.RoundId, revision, Plugin.TdmtatEnabled.Value ? "1" : "0",
            "1");
        MyceliumNetwork.RPC(Plugin.TdmtatModId,
            nameof(Plugin.SyncTdmtatSettings), ReliableType.Reliable,
            MyceliumNetwork.LobbyHost, GameModeManager.RoundId, revision,
            Plugin.TdmtatEnabled.Value, true);
    }
    ...
    internal static void OnPlayerEntered(CSteamID player)
    {
        ...
        MyceliumNetwork.RPCTarget(Plugin.TdmtatModId,
            nameof(Plugin.SyncTdmtatSettings), player, ReliableType.Reliable,
    ...
    internal static void OnServerKill(int deadPlayerId, int killerId)
    {
        ...
        int nextScore = TdmtatRules.AddKillPoints(currentScore,
        ...
        if (TdmtatRules.IsMatchWon(nextScore, GameModeManager.EffectivePointsToWin))
        {
    ...
    private static void BroadcastLiveState()
    {
        ...
        MyceliumNetwork.RPC(Plugin.TdmtatModId,
            nameof(Plugin.SyncTdmtatLiveState), ReliableType.Reliable,
    ...
    private static void SendLiveStateTo(CSteamID player)
    {
        ...
        MyceliumNetwork.RPCTarget(Plugin.TdmtatModId,
            nameof(Plugin.SyncTdmtatLiveState), player, ReliableType.Reliable,
    ...
    private static void ApplyLobbySettingsSnapshot()
    {
        if (!ModeLobbyDataSync.TryRead(SettingsLobbyDataKey, 2, out CSteamID hostId,
            ...
            || !Sync.TryAcceptSettingsSnapshot(hostId, roundId, revision,
                ModeLobbyDataSync.Source("tdmtat", "settings")))
        {
            return;
        }
    ...
    private static void ApplyLobbyLiveSnapshot()
    {
        ...
        ApplyLiveState(hostId, fields[0], teamCount, fields[2], roundId, revision,
            ModeLobbyDataSync.Source("tdmtat", "live"));
    }
